...
inline void irq_restore(uint32_t flags) {
    __asm__ volatile("csrw mstatus, %0" : : "r"(flags) : "memory");
}
...
inline void _pmp_set_cfg(uint8_t idx, uint8_t cfg_byte) noexcept {
    ...
    switch (idx >> 2) {
    case 0:
        __asm__ volatile("csrr %0, pmpcfg0" : "=r"(reg_val));
        break;
    case 1:
        __asm__ volatile("csrr %0, pmpcfg1" : "=r"(reg_val));
        break;
    case 2:
        __asm__ volatile("csrr %0, pmpcfg2" : "=r"(reg_val));
        break;
    case 3:
        __asm__ volatile("csrr %0, pmpcfg3" : "=r"(reg_val));
        break;
    default:
        return;
    }
    ...
    switch (idx >> 2) {
    case 0:
        __asm__ volatile("csrw pmpcfg0, %0" : : "r"(reg_val));
        break;
    case 1:
        __asm__ volatile("csrw pmpcfg1, %0" : : "r"(reg_val));
        break;
    case 2:
        __asm__ volatile("csrw pmpcfg2, %0" : : "r"(reg_val));
        break;
    case 3:
        __asm__ volatile("csrw pmpcfg3, %0" : : "r"(reg_val));
        break;
    }
}
...
inline void mpu_configure_region(uint8_t idx, const MpuRegion& r) noexcept {
    if (idx >= 16u)
        return; // QEMU virt 最多 16 张 PMP

    // NAPOT 地址编码: (base >> 2) | ((size/2 - 1) >> 2)
    // size = 2^size_pow2, NAPOT要求 size >= 8 字节
    uint32_t napot_addr;
    if (r.size_pow2 >= 3u) {
        napot_addr = (static_cast<uint32_t>(r.base) >> 2) | ((1u << (r.size_pow2 - 3u)) - 1u);
    } else {
    ...
    switch (idx) {
    case 0:
        __asm__ volatile("csrw pmpaddr0,  %0" : : "r"(napot_addr));
        break;
    case 1:
        __asm__ volatile("csrw pmpaddr1,  %0" : : "r"(napot_addr));
        break;
    case 2:
        __asm__ volatile("csrw pmpaddr2,  %0" : : "r"(napot_addr));
        break;
    case 3:
        __asm__ volatile("csrw pmpaddr3,  %0" : : "r"(napot_addr));
        break;
    case 4:
        __asm__ volatile("csrw pmpaddr4,  %0" : : "r"(napot_addr));
        break;
    case 5:
        __asm__ volatile("csrw pmpaddr5,  %0" : : "r"(napot_addr));
        break;
    case 6:
        __asm__ volatile("csrw pmpaddr6,  %0" : : "r"(napot_addr));
        break;
    case 7:
        __asm__ volatile("csrw pmpaddr7,  %0" : : "r"(napot_addr));
        break;
    case 8:
        __asm__ volatile("csrw pmpaddr8,  %0" : : "r"(napot_addr));
        break;
    case 9:
        __asm__ volatile("csrw pmpaddr9,  %0" : : "r"(napot_addr));
        break;
    case 10:
        __asm__ volatile("csrw pmpaddr10, %0" : : "r"(napot_addr));
        break;
    case 11:
        __asm__ volatile("csrw pmpaddr11, %0" : : "r"(napot_addr));
        break;
    case 12:
        __asm__ volatile("csrw pmpaddr12, %0" : : "r"(napot_addr));
        break;
    case 13:
        __asm__ volatile("csrw pmpaddr13, %0" : : "r"(napot_addr));
        break;
    case 14:
        __asm__ volatile("csrw pmpaddr14, %0" : : "r"(napot_addr));
        break;
    case 15:
        __asm__ volatile("csrw pmpaddr15, %0" : : "r"(napot_addr));
        break;
    default:
        return;
    }
