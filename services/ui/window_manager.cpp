...
extern FrameBuffer<192, 490> g_fb; // A typical size in AuroraOS? (Wait, we should check `mini_program_engine.hpp` for
                                   // size, but let's use a template placeholder or a known global)
