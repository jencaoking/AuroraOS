 ...
 * @brief Maintains the single UserContext for JARVIS
 */
#ifndef AURORA_JARVIS_CONTEXT_MANAGER_HPP
#define AURORA_JARVIS_CONTEXT_MANAGER_HPP
...
#endif  // AURORA_JARVIS_CONTEXT_MANAGER_HPP
