 ...
 * @brief Rule-based + sensor-driven Intent Engine (JARVIS Phase 1)
 */
#ifndef AURORA_JARVIS_INTENT_ENGINE_HPP
#define AURORA_JARVIS_INTENT_ENGINE_HPP
...
public:
    ...
    Intent parse_text(const char* utterance, uint32_t now_ms) {
        ...
        } else if (contains_ci(utterance, "hello") ||
                   contains_ci(utterance, "aurora") ||
                   is_hi(utterance)) {
...
#endif  // AURORA_JARVIS_INTENT_ENGINE_HPP
