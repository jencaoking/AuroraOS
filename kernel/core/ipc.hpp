...
// IPC message type IDs 鈥?0 is reserved for raw/untyped messages
...
// Type-safe IPC call 鈥?compile-time checked
template<typename T>
...
// Type-safe IPC receive 鈥?returns true if type matches
template<typename T>
