...
public:
    ...
    void draw_arc(int16_t cx, int16_t cy, uint16_t r,
        ...
        constexpr uint8_t SIN_Q8[91] = {
            0,   4,   9,  13,  18,  22,  27,  31,  36,  40,  44,  49,  53,
           57,  62,  66,  70,  74,  79,  83,  87,  91,  95,  99, 103, 107,
          111, 115, 119, 122, 126, 130, 133, 137, 140, 144, 147, 150, 154,
          157, 160, 163, 166, 169, 172, 175, 177, 180, 183, 185, 188, 190,
          192, 195, 197, 199, 201, 203, 205, 207, 209, 210, 212, 213, 215,
          216, 218, 219, 220, 221, 222, 223, 224, 225, 226, 226, 227, 228,
          228, 229, 229, 229, 230, 230, 230, 230, 230, 230, 230, 230, 230
        };
...
private:
    ...
    [[nodiscard]] static int16_t sin_approx(uint16_t deg,
                                             uint16_t radius,
                                             const uint8_t sin_q8[91]) noexcept {
